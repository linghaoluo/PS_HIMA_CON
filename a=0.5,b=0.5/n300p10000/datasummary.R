...
for (i in 1:500){
  estimate_ab_Pscw[i,1]<-results_Pscw_n300p10000[[i]]["M1",4]
  estimate_ab_Pscw[i,2]<-results_Pscw_n300p10000[[i]]["M2",4]
  estimate_ab_Pscw[i,3]<-results_Pscw_n300p10000[[i]]["M3",4]
  estimate_ab_Pscw[i,4]<-results_Pscw_n300p10000[[i]]["M4",4]
  estimate_ab_Pscw[i,5]<-results_Pscw_n300p10000[[i]]["M5",4]
  estimate_ab_Pscw[i,6]<-results_Pscw_n300p10000[[i]]["M6",4]
  estimate_ab_Pscw[i,7]<-results_Pscw_n300p10000[[i]]["M7",4]
  estimate_ab_Pscw[i,8]<-results_Pscw_n300p10000[[i]]["M8",4]
  
  estimate_ab_Iptw[i,1]<-results_Iptw_n300p10000[[i]]["M1",4]
  estimate_ab_Iptw[i,2]<-results_Iptw_n300p10000[[i]]["M2",4]
  estimate_ab_Iptw[i,3]<-results_Iptw_n300p10000[[i]]["M3",4]
  estimate_ab_Iptw[i,4]<-results_Iptw_n300p10000[[i]]["M4",4]
  estimate_ab_Iptw[i,5]<-results_Iptw_n300p10000[[i]]["M5",4]
  estimate_ab_Iptw[i,6]<-results_Iptw_n300p10000[[i]]["M6",4]
  estimate_ab_Iptw[i,7]<-results_Iptw_n300p10000[[i]]["M7",4]
  estimate_ab_Iptw[i,8]<-results_Iptw_n300p10000[[i]]["M8",4]
  
  estimate_ab_Non[i,1]<-results_Non_n300p10000[[i]]["M1",4]
  estimate_ab_Non[i,2]<-results_Non_n300p10000[[i]]["M2",4]
  estimate_ab_Non[i,3]<-results_Non_n300p10000[[i]]["M3",4]
  estimate_ab_Non[i,4]<-results_Non_n300p10000[[i]]["M4",4]
  estimate_ab_Non[i,5]<-results_Non_n300p10000[[i]]["M5",4]
  estimate_ab_Non[i,6]<-results_Non_n300p10000[[i]]["M6",4]
  estimate_ab_Non[i,7]<-results_Non_n300p10000[[i]]["M7",4]
  estimate_ab_Non[i,8]<-results_Non_n300p10000[[i]]["M8",4]
  
  estimate_ab_Pscov[i,1]<-results_Pscov_n300p10000[[i]]["M1",4]
  estimate_ab_Pscov[i,2]<-results_Pscov_n300p10000[[i]]["M2",4]
  estimate_ab_Pscov[i,3]<-results_Pscov_n300p10000[[i]]["M3",4]
  estimate_ab_Pscov[i,4]<-results_Pscov_n300p10000[[i]]["M4",4]
  estimate_ab_Pscov[i,5]<-results_Pscov_n300p10000[[i]]["M5",4]
  estimate_ab_Pscov[i,6]<-results_Pscov_n300p10000[[i]]["M6",4]
  estimate_ab_Pscov[i,7]<-results_Pscov_n300p10000[[i]]["M7",4]
  estimate_ab_Pscov[i,8]<-results_Pscov_n300p10000[[i]]["M8",4]
  
  estimate_ab_Cov[i,1]<-results_Cov_n300p10000[[i]]["M1",4]
  estimate_ab_Cov[i,2]<-results_Cov_n300p10000[[i]]["M2",4]
  estimate_ab_Cov[i,3]<-results_Cov_n300p10000[[i]]["M3",4]
  estimate_ab_Cov[i,4]<-results_Cov_n300p10000[[i]]["M4",4]
  estimate_ab_Cov[i,5]<-results_Cov_n300p10000[[i]]["M5",4]
  estimate_ab_Cov[i,6]<-results_Cov_n300p10000[[i]]["M6",4]
  estimate_ab_Cov[i,7]<-results_Cov_n300p10000[[i]]["M7",4]
  estimate_ab_Cov[i,8]<-results_Cov_n300p10000[[i]]["M8",4]
} 
...
{
  Choose_Cov=data.frame(choose(results_Cov_n300p10000))
  Choose_Cov['Method']='Cov'
 
  Choose_Iptw=data.frame(choose(results_Iptw_n300p10000))
  Choose_Iptw['Method']='Iptw'
  
  Choose_Pscov=data.frame(choose(results_Pscov_n300p10000))
  Choose_Pscov['Method']='Pscov'
  
  Choose_Non=data.frame(choose(results_Non_n300p10000))
  Choose_Non['Method']='Non'
  
  Choose_Psuni=data.frame(choose(results_Pscw_n300p10000))
