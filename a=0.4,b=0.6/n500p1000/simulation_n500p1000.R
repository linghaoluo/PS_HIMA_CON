...
results_Pscw_n500p1000<-list() 
results_Iptw_n500p1000<-list() 
results_Pscov_n500p1000<-list() 
results_Non_n500p1000<-list() 
results_Cov_n500p1000<-list() 
for (v in 1:500) {
  n <- 500   # sample size
  ...
  results_Pscw_n500p1000[[v]]=myhima(sim_data,method='Psuni',v)
  results_Iptw_n500p1000[[v]]=myhima(sim_data,method='Iptw',v)   
  results_Pscov_n500p1000[[v]]=myhima(sim_data,method='Pscov',v)
  results_Non_n500p1000[[v]]=myhima(sim_data,method='Non',v)
  results_Cov_n500p1000[[v]]=myhima(sim_data,method='Cov',v)
}
